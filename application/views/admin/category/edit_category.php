        ...
        <div class="col-lg-12">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white"> Edit Category <a href="<?php echo base_url('admin/category/all_category_list') ?>" class="btn btn-info pull-right"><i class="fa fa-list"></i> List Categories </a></h4>
