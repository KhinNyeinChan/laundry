            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="<?php echo base_url('admin/dashboard') ?>">
                        ...
                        <span>
                         ...
                         <h2 class="text-white font-weight-bold">Laundry</h2></a>
                </div>
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="#" id="0" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="mdi mdi-email"></i>
                                <div class="notify"> <span class="heartbit"></span> <span class="point"></span> </div>
                            </a>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li><!--mod by knc-->
                            <a class="waves-effect waves-dark" href="<?php echo base_url('admin/pos') ?>" aria-expanded="false"><i class="fa fa-th"></i><span class="hide-menu">POS</span></a>
                        </li>

                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="<?php echo base_url('admin/user/all_user_list') ?>" aria-expanded="false"><i class="fa fa-users"></i><span class="hide-menu">People</span></a>
                            <ul aria-expanded="false" class="collapse">

                                <?php if ($this->session->userdata('role') == 'admin'): ?>
                                    <li><a href="<?php echo base_url('admin/user/all_user_list') ?>"><i class="fa fa-angle-right"></i> List Users</a></li>
                                    ...
                                    <li><a href="<?php echo base_url('admin/user/power') ?>"><i class="fa fa-angle-right"></i> Add User Power</a></li>
                                     <li><a href="<?php echo base_url('admin/customer/all_customer_list') ?>"><i class="fa fa-angle-right"></i> List Customers</a></li>
                                    <li><a href="<?php echo base_url('admin/customer') ?>"><i class="fa fa-angle-right"></i> Add Customer </a></li>
                        ...
                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="<?php echo base_url('admin/product/all_product_list') ?>" aria-expanded="false"><i class="fa fa-barcode"></i><span class="hide-menu">Products</span></a>
                            <ul aria-expanded="false" class="collapse">

                                <?php if ($this->session->userdata('role') == 'admin'): ?>
                                    <li><a href="<?php echo base_url('admin/product/all_product_list') ?>"><i class="fa fa-angle-right"></i> List Products</a></li>
                                    <li><a href="<?php echo base_url('admin/product') ?>"><i class="fa fa-angle-right"></i> Add Product </a></li>
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <?php if ($this->session->userdata('role') == 'admin'): ?>
                                    <li><a href="<?php echo base_url('admin/category/all_category_list') ?>"><i class="fa fa-angle-right"></i> List Categories</a></li>
                                    <li><a href="<?php echo base_url('admin/category') ?>"><i class="fa fa-angle-right"></i> Add Category </a></li>
                         ...
                         <li>
                            <a class="has-arrow waves-effect waves-dark" href="<?php echo base_url('admin/order/all_order_list') ?>" aria-expanded="false"><i class="fa fa-check-square-o"></i><span class="hide-menu">Orders</span></a>
                            <ul aria-expanded="false" class="collapse">
                        ...
                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="<?php echo base_url('admin/sale/all_sale_list') ?>" aria-expanded="false"><i class="fa fa-shopping-cart"></i><span class="hide-menu">Sales</span></a>
                            <ul aria-expanded="false" class="collapse">

                                <?php if ($this->session->userdata('role') == 'admin'): ?>
                                    <li><a href="<?php echo base_url('admin/sale/all_sale_list') ?>"><i class="fa fa-angle-right"></i> List Sales</a></li>
                                    <li><a href="<?php echo base_url('admin/sale/all_openBill_list') ?>"><i class="fa fa-angle-right"></i> List Opened Bills </a></li>
                         ...
                         <li>
                            <a class="has-arrow waves-effect waves-dark" href="<?php echo base_url('admin/expense/all_expense_list') ?>" aria-expanded="false"><i class="fa fa-plus"></i><span class="hide-menu">Expenses</span></a>
                            <ul aria-expanded="false" class="collapse">

                                <?php if ($this->session->userdata('role') == 'admin'): ?>
                                    <li><a href="<?php echo base_url('admin/expense/all_expense_list') ?>"><i class="fa fa-angle-right"></i> List Expenses</a></li>
                                    <li><a href="<?php echo base_url('admin/expense') ?>"><i class="fa fa-angle-right"></i> Add Expense </a></li>
                                     <li><a href="<?php echo base_url('admin/expense_category/all_expense_category_list') ?>"><i class="fa fa-angle-right"></i> List Expense Categories</a></li>
                                    <li><a href="<?php echo base_url('admin/expense_category') ?>"><i class="fa fa-angle-right"></i> Add Expense Category </a></li>
