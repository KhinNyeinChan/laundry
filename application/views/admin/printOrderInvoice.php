...
<body>
    <div class="container-fluid">
        <div id="wrapper">
            ...
            <div class="alert alert-success">Order successfully added !
            ...
            <div class="container printableArea">
                ...
                <div class="row">
                    <p class="text-left">
                        Date : <?= $orders['start_date'] ?> <br>
                        Sales Person : <?= $orders['created_by'] ?>   <br>
                        Order No : <?= $orders['id'] ?>  <br>
                        Customer Name : <?= $customer['name'] ?>  <br>
                        Customer Phone : <?= $customer['phone'] ?>  <br>
                        Pick up Date : <?= $orders['end_date'] ?>  
                    </p>                                                                                              
                </div>
                    ...
                    <div class="table-responsive m-t-40" style="clear: both;">
                        <table class="table table-hover">
                            ...
                            <?php foreach($products as $product) : ?>
                                ...
                                <td class="text-right"><?= number_format(($product['quantity'] * $product['product_price'])) ?></td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
                        </table>
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-3 text-right"><?= number_format($orders['total']) ?></div>
                    </div>
                    <div class="row">
                        <div class="col-3"></div>
                        <div class="col-3"></div>
                        <div class="col-3 text-right">Discount</div>
                        <div class="col-3 text-right"><?= number_format($orders['discount']) ?></div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-3"></div>
                        ...
                        <div class="col-3 text-right"><?= number_format($orders['subtotal']) ?></div>
                    </div>
                    <div class="row">
                        <div class="col-3"></div>
                        <div class="col-3"></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-3 text-right">unpaid</div>
                    </div>
