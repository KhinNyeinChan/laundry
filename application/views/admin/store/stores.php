        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <?php if ($this->session->userdata('role') == 'admin'): ?>
                    <a href="<?php echo base_url('admin/store') ?>" class="btn btn-info pull-right"><i class="fa fa-plus"></i> Stores</a> &nbsp;
                                ...
                                <tr>
                                    ...
                                    <td class="text-nowrap">
                                        ...
                                        <?php if ($this->session->userdata('role') == 'admin'): ?>
                                            ...
                                            <span data-toggle="modal" data-target="#confirm_delete_<?php echo $store['id'];?>">
