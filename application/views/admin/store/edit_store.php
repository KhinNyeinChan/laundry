        ...
        <div class="col-lg-12">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white"> Edit Store <a href="<?php echo base_url('admin/store/all_store_list') ?>" class="btn btn-info pull-right"><i class="fa fa-list"></i>  Stores </a></h4>

                </div>
                <div class="card-body">
                    <form method="post" action="<?php echo base_url('admin/store/update/'.$store->id) ?>" class="form-horizontal" novalidate>
                        <div class="form-body">
                            <br>
                            <div class="row">
                                <div class="col-md-9">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9 controls">
                                            <input type="text" name="name" class="form-control" value="<?php echo $store->name; ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                                <!--/span-->
                             ...
                             <div class="row">
                                <div class="col-md-9">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9 controls">
                                            <input type="file" name="logo" class="form-control" value="<?php echo $store->logo; ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                                <!--/span-->
                             ...
                             <div class="row">
                                <div class="col-md-9">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9 controls">
                                        <textarea id="receipt_header" class="form-control tip" name="receipt_header" cols="40" rows="10" style="height: 100px" ><?php echo ($store->receipt_header); ?></textarea>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9 controls">
                                        <textarea id="receipt_footer" class="form-control tip" name="receipt_footer" cols="40" rows="10" style="height: 100px" ><?php echo ($store->receipt_footer); ?></textarea>
                                        </div>
