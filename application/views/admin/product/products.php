        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <?php if ($this->session->userdata('role') == 'admin'): ?>
                    <a href="<?php echo base_url('admin/product') ?>" class="btn btn-info pull-right"><i class="fa fa-plus"></i> Add New Product</a> &nbsp;
...
<div class="modal fade" id="confirm_delete_<?php echo $product['id'];?>">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="form-body">
                ...
                <a href="<?php echo base_url('admin/product/delete/'.$product['id']) ?>" class="btn btn-danger"> Delete</a>
