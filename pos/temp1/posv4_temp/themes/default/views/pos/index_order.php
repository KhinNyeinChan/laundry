                                            ...
                                            <div class="col-xs-4" style="padding: 0;">
                                                ...
                                                <div class="btn-group-vertical btn-block">
                                                    ...
                                                    <!-- mod by Nyi Nyi to show/hide bill/payment for waiter role -->
                                                        <?php if (($this->Admin) || ($this->Manager)  || ($this->Staff) || ((($this->Waiter) &&(config_item('waiter_settle_payment'))))){ ?>
                                ...
                                <div class="contents" id="right-col">
                                    ...
                                    <div class="product-nav">
                                        <div class="btn-group btn-group-justified">
                                            ...
                                            <!-- mod added for waiter role by Nyi Nyi on 23rd Jan 2018 -->
                                            <?php if (!$Waiter && config_item('gift_card')) { ?>
                                            <div class="btn-group">
...
<!-- Wholesale Mod by mtk -->
                ...
                <div class="col-sm-8">                    
                    ...
                    <div class="col-sm-3">                
                      <div class="form-group">                  
                       <input type="button" class="btn btn-link" style="background-color: #ffffff" id="nWholeSale">
                      </div>
                    </div>

                    <div class="col-sm-3">
                      <div class="form-group">
                        <input type="button" class="btn btn-link" style="background-color: #ffffff" id="nWholeSale1">
                      </div>
                    </div> 

                    <div class="col-sm-3">
                      <div class="form-group">
                        <input type="button" class="btn btn-link" style="background-color: #ffffff" id="nWholeSale2">
                      </div>
                    </div>

                    <div class="col-sm-3">
                      <div class="form-group">
                        <input type="button" class="btn btn-link" style="background-color: #ffffff" id="nWholeSale3">
                      </div>
                    </div>

                    <div class="col-sm-3">
                      <div class="form-group">
                        <input type="button" class="btn btn-link" style="background-color: #ffffff" id="nWholeSale4">
                      </div>
                    </div>
...
<div class="modal" data-easein="flipYIn" id="delModal" tabindex="-1" role="dialog" aria-labelledby="susModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                <h4 class="modal-title" id="susModalLabel"><?= lang('delete_items'); ?></h4>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <?= lang("reason", "reason"); ?>
                    <?php echo form_input('reason', $reason, 'class="form-control kb-text" id="reason"'); 
                    ?>
                </div>
