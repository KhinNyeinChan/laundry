                    ...
                    <div class="col-md-6">
                        ...
                        <?php if ($Admin) { ?>
                            ...
                            <?= lang('expense_category', 'expenses'); ?>
                                    <?php
                                    $ex[''] = lang("select")." ".lang("expenses_category");
                                    foreach($expenses_categories as $expenses) {
                                        $ex[$expenses->id] = $expenses->name;
                                    }
                                    ?>       
           <?= form_dropdown('expense_id', $ex, $expense->ecategory_id, 'class="form-control select2 tip" id="expense_id"  required="required" style="width:100%;"'); ?>                                </div>
