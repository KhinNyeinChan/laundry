...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#SLRData').DataTable({
			...
			/* mod by nyi nyi on 5th July 2018 to link Sale No to View Sale*/
			{ "data" : "id" , 
			"render": function(data, type, row, meta){
			
            if(type === 'display'){
                //data = '<a href= ' + document.location.pathname.split('/').slice(0, -1).join('/') + '/pos/view/' + data + '/1 target="_blank">' + data + '</a>';
				data = '<a href= ' + document.location.pathname.split('/').slice(0, -1).join('/') + '/pos/view/' + data + '/1 title="View Sale" class="tip btn btn-primary btn-small" data-toggle="ajax-modal">' + data + '</a>';
            }
            return data;
			}
			},
            ...
            { "data": "date", "render": hrld ,"searchable": false },
            { "data": "customer_name" },
            ...
            { "data": "balance", "render": currencyFormat,"searchable": false }, 
			//end mod 
                    ...
                    <div class="row">
				       ...
				       <tr>
                                        ...
                                        <tr class="active">
											...
											<th class="col-sm-1"><?= lang("sale_no"); ?></th>
											<!-- end mod -->
                                    ...
                                    <tfoot>
                                        <tr class="active">
                                            <th style="max-width:30px;"><input type="text" class="text_filter" placeholder="[<?= lang('sale_no'); ?>]"></th>
