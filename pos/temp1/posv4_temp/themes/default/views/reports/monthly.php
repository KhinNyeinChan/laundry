                                ...
                                <tr>
                                    ...
                                    if (!empty($sales)) {
                                        ...
                                        foreach ($sales as $value) {
                                            ...
                                            "<br><span style='float:right;font-weight:bold;'>{$this->tec->formatMoney($value->tax)}</span></td></tr><tr><td style='text-align:left;font-weight:bold;' class='violet'>".lang('service_charges').// mod by mtk at 26 Feb 2019 for service charges
                                            "<br><span style='float:right;font-weight:bold;'>{$this->tec->formatMoney($value->service_charges)}</span></td></tr><tr><td style='text-align:left;font-weight:bold;' class='violet'>".lang('discount').
