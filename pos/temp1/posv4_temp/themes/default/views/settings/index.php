                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?= form_input('site_name', $settings->site_name, 'class="form-control"  id="site_name" required="required" readonly '); ?>
                                </div>
                                <div class="form-group">
                                    <?= lang("tel", 'tel'); ?>
                                ...
                                <?php if(config_item('service_charges') && config_item('is_restaurant')){ ?>
                                <div class="form-group">
                                    <?= lang("service_charges", 'default_service_charges'); ?>
                                    <?= form_input('sc', $settings->service_charges, 'class="form-control" id="default_service_charges" required="required"'); ?>
                                </div>
                                <?php } 
                                      else {
                                ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                   ...
                                   //$rnd = array('0' => lang('disable'), '1' => lang('enable'), '2' =>lang('to_nearest_050'), '3' => lang('to_nearest_number'), '4' => lang('to_next_number'));
                                   $rnd = array('0' => lang('disable'), '1' => lang('round_up_to_nearest_50 ( eg. 1180 => 1200 )'), '2' => lang('round_down_to_nearest_50 (eg. 1040 => 1000)'), '3' => lang('round_up_or_down (eg. 1120 => 1100 or 1140 => 1150)'));
