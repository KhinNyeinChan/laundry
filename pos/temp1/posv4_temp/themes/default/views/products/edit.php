                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
								...
								<!-- #mod Raw Added by Nyi Nyi at 7/4/2017 -->
								<?php //$opts = array('standard' => lang('standard'), 'combo' => lang('combo'), 'service' => lang('service'));  ?>
                                <?php $opts = array('standard' => lang('standard'), 'combo' => lang('combo'), 'service' => lang('service'), 'Raw' => lang('raw_materials'));  ?>
                                ...
                                <!-- mod my mtk at 17 Jan 2019 to generate auto product code -->
                                    <?php if (config_item('auto_generate')) { ?>     
                                <div class="form-group all">
                                  <?= lang("product_code", "code") ?>
                                   <div class="input-group">
                                        <?php echo form_input('code', $product->code, 'class="form-control" id="code" required="required"'); ?>
                                ...
                                <?php } 
                                    ...
                                    <?= form_input('code',  $product->code, 'class="form-control tip" id="code"  placeholder="Alphanumeric value with no space" required="required"'); ?>
                                    </div>
                                <?php } ?>
                                <!-- end mod -->
                                <div class="form-group all">
                                ...
                                <div class="form-group">
                                    <?= lang('brand', 'brand'); ?>
                                    <?php
                                    $bran[''] = lang("select")." ".lang("brand");
                                    foreach($brands as $brand) {
                                        $bran[$brand->id] = $brand->name;
                                    }
                                    ?>
                                    <?= form_dropdown('brand_id', $bran,$product->brand_id, 'class="form-control select2 tip" id="brand_id"'); ?>
                                </div>
                                <?php } ?>
                                ...
                                <div class="form-group">
                                    ...
                                    ?>
                                    <?= form_dropdown('unit_id', $uni,$product->unit_id, 'class="form-control select2 tip" id="unit_id"'); ?>
                                </div>
                                ...
                                <!-- mod by mtk at 23/1/2019 to show wholesale price -->
                                <?php if (config_item('show_wholesale_price') && !config_item('is_restaurant')) { ?>
                                 
                                       <div class="form-group">
                                       <?= lang('wholesale', 'details'); ?>
                                       <?= form_input('details', $product->details, 'class="form-control input-sm" id="details"  required="required"'); ?>
                                       </div>
                                ...
                                <div class="form-group">
                                 ...
                                 <!--#mod #mod1 tax method hidden by zay yar at 9/12/2018 -->
                                <!--
                                <div class="form-group">
                        ...
                        <!-- mod by mtk at 23/1/2019 to show wholesale price -->
                <?php if ( !config_item('show_wholesale_price')) { ?>
                        <div class="form-group">
