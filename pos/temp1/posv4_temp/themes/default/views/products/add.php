                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <?php } 
                                    ...
                                    <?= form_input('code', set_value('code'), 'class="form-control tip" id="code"  placeholder="Alphanumeric value with no space" required="required"'); ?>
                                    </div>
                                <?php } ?>
                                <!-- end mod -->
                                ...
                                <?php if (!config_item('is_restaurant')) { ?>
                                 <div class="form-group">
                                   ...
                                   // $brand=array();
                                    ...
                                    ?>
                                    <?= form_dropdown('brand', $bran, set_value('brand'), 'class="form-control select2 tip" id="brand"  style="width:100%;"'); ?>
                                </div>
                                <?php } ?>
                                <div class="form-group">
                                    <?= lang('unit', 'unit'); ?>
                               ...
                               //     $uni[''] = lang("select")." ".lang('unit');
                                   // $brand=array();
                                    ...
                                    ?>
                                    <?= form_dropdown('unit', $uni, set_value('unit'), 'class="form-control select2 tip" id="unit"  style="width:100%;"'); ?>
                                </div>
                                ...
                                <?php if (config_item('show_wholesale_price') && !config_item('is_restaurant')) { ?>
                                       ...
                                       <?= form_input('details', set_value('details'), 'class="form-control tip" id="details"  required="required"'); ?>
                                       </div>
