        ...
        <div class="col-xs-12">
            <div class="box box-success">
                ...
                <div class="box-body">
                    ...
                    <?php if ($this->session->userdata('store_id')) { ?>
                        <?php if (($Staff) && config_item('staff_view_sales') || ($Admin) || ($Manager)) { ?>
                    <a class="btn btn-app" href="<?= site_url('sales'); ?>">
                        <i class="fa fa-shopping-cart"></i> <?= lang('sales'); ?>
                    </a>
                    <?php } ?>
                    <?php if(config_item('is_restaurant') && config_item('order_tracking')) { ?>
                    <a class="btn btn-app" href="<?= site_url('orders/list_orders'); ?>">
                        <i class="fa fa-check-square-o"></i> <?= lang('orders'); ?>
                    </a>
                    <?php } ?>
		     ...
		     <?php } ?>
                    ...
                    #mod #mod1 update icon removed by zay yar at 18/2/2018
...
-->
					...
					<?php if ($Manager) { ?>
                   <?php if (config_item('manager_view_report')) { ?>
                    <a class="btn btn-app" href="<?= site_url('reports'); ?>">
                        <i class="fa fa-bar-chart-o"></i> <?= lang('reports'); ?>
                    </a>
					<?php } ?>
