...
class Products_model extends CI_Model
{
    ...
    public function addUnit($data = array()) {
 ...
 public function getAllunits() {
    ...
    public function fetch_products($limit, $start, $category_id = NULL) {
        ...
        ->limit($limit, $start)->order_by("name", "asc");
        if ($category_id) {
            $this->db->where('category_id', $category_id);
        }
        $q = $this->db->get("products");
...
public function updateBrands($id, $data = array()) {
        if ($this->db->update('brands', $data, array('id' => $id))) {
            return true;
        }
        return false;
    }
    public function updateUnits($id, $data = array()) {
        if ($this->db->update('unit', $data, array('id' => $id))) {
            return true;
        }
        return false;
    }
...
public function deleteBrand($id) {
    ...
    public function deleteUnit($id) {
        if ($this->db->delete('unit', array('id' => $id))) {
            return true;
        }
        return FALSE;
    }
