...
$(document).ready(function () {
    ...
    $('#print_order').click(function (e) {
           ...
           // alert($('#total_quantity').val(count - 1));
            ...
            $('#ccname').val(name);
             suspend = $('<span></span>');
              if (sid !== 0) {
               suspend.html('<input type="hidden" name="print_order" value="3" /><input type="hidden" name="ccname" value="5" />');
            } else {
               suspend.html('<input type="hidden" name="print_order" value="3" /><input type="hidden" name="ccname" value="6" />');
            } 
           suspend.appendTo("#hidesuspend");
        e.preventDefault();
        if (count <= 1) {
