...
<body class="login-page login-page-<?= $Settings->theme_style; ?>">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?=base_url();?>"><?= $Settings->site_name == 'iWavePOS' ? 'iWave<b>POS</b>' : '<img src="'.base_url('uploads/'.$Settings->logo).'" alt="'.$Settings->site_name.'" />'; ?></a>
        </div>
        <div class="login-box-body">
            ...
            <div class="form-group has-feedback">
                <input type="text" name="identity" value="<?= set_value('identity', (DEMO ? 'admin@iwave.com' : '')); ?>" class="form-control" placeholder="<?= lang('email'); ?>" />
			...
			<!-- mod by Nyi Nyi to hide "remember me" on 23rd Jan 2018 -->
			<!--
            <div class="checkbox pull-left" style="margin-top: 0;">
                <div class="custom-checkbox">
                <!--#mod #mod1 remember me button change by zay yar at 28/2/2017 
                    <?php //echo form_checkbox('remember', '1', FALSE, 'id="remember"'); ?>
                    <label for="remember" style="padding-left:5px;"></label>
                </div>
            </div>
			-->
