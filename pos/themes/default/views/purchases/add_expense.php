                    ...
                    <div class="col-md-6">
                      <?= form_open_multipart("purchases/add_expense"); ?>
                        ...
                        <?php if ($Admin) { ?>
                            ...
                            <div class="form-group">
                                    <?= lang('expense_category', 'expenses'); ?>
                                    <?php
                                    $ex[''] = lang("select")." ".lang("expense_category");
                                    foreach($expenses_categories as $expense) {
                                        $ex[$expense->id] = $expense->name;
                                    }
                                    ?>
                                    <?= form_dropdown('expense', $ex, set_value('id'), 'class="form-control select2 tip" id="expense"  required="required" style="width:100%;"'); ?>
                                </div>
...
<script src="<?= $assets ?>plugins/bootstrap-datetimepicker/js/moment.min.js" type="text/javascript"></script>da
