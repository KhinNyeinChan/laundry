...
<section class="content">
	...
	<!-- Mod Nyi Nyi 2nd May 2017 -->
                            ...
                            <div class="form-group">
                                <?= lang("brand", "brand") ?>
                                <?php
                                $bra[0] = lang('select').' '.lang('brand');
                                foreach ($brands as $brand) {
                                    $bra[$brand->id] = $brand->name;
                                }
                                echo form_dropdown('brand', $bra, (isset($_POST['brand']) ? $_POST['brand'] : ''), 'class="form-control select" id="brand" placeholder="' . lang("select") . " " . lang("brand") . '" style="width:100%"')
                                ?>
                            </div>
                        </div>
                            <div class="col-xs-4">
