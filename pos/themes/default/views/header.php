...
<div class="wrapper">
    ...
    <header class="main-header">
        <a href="<?= site_url(); ?>" class="logo">
            ...
            <span class="logo-lg"><?= $store->name == 'Innowave' ? 'iWave <b>POS</b>' : $store->name; ?></span>
            <?php } else { ?>
            <span class="logo-mini">POS</span>
            <span class="logo-lg"><?= $Settings->site_name == 'Innowave' ? 'iWave <b>POS</b>' : $Settings->site_name; ?></span>
            <?php } ?>
        </a>
        ...
        <section class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li class="treeview mm_products">
                   ...
                   <!--     <li id="products_print_barcodes"><a href="<?= site_url('products/print_barcodes'); ?>" data-toggle="ajax-modal"><i class="fa fa-circle-o"></i> <?= lang('print_barcodes'); ?></a></li>
                        <li id="products_print_labels"><a href="<?= site_url('products/print_labels'); ?>" data-toggle="ajax-modal"><i class="fa fa-circle-o"></i> <?= lang('print_labels'); ?></a></li> 
			-->
           ...
           <?php   } ?>
                ...
                <li class="treeview mm_settings">
                    ...
                    <?php // #mod #mod1 update setting removed by Zayar at 25/8/2016 ?>
                    <ul class="treeview-menu">
